            ...
            <div class="q-pa-xl">
                ...
                <div class="row justify-center">
                    <div class="col-3">
                        <ul>
                            <li>
                                <router-link :to="{ name: 'networks', params: { asn: 'AS2497' } }" class="IHR_delikify"
                                    >IIJ (AS2497)</router-link
                                >
                            </li>
                            <li>
                                <router-link :to="{ name: 'networks', params: { asn: 'AS15169' } }" class="IHR_delikify"
                    ...
                    <div class="col-3">
                        <ul>
                            <li>
                                <router-link :to="{ name: 'networks', params: { asn: 'AS7922' } }" class="IHR_delikify"
                            ...
                            <li>
                                <router-link :to="{ name: 'networks', params: { asn: 'IXP208' } }" class="IHR_delikify"
