...
<template>
  ...
  >
        ...
        <template v-slot:body-cell-delegatedPrefixStatus="props">
            <q-td :props="props">
                <span color="red" v-if="props.row.delegated_prefix_status == 'available' | props.row.delegated_prefix_status == 'reserved'">
                    <q-icon name="fas fa-times" color="red" left />
        ...
        <template v-slot:body-cell-delegatedASNStatus="props">
            <q-td :props="props">
                <span color="red" v-if="props.row.delegated_asn_status == 'available' | props.row.delegated_asn_status == 'reserved'">
                    <q-icon name="fas fa-times" color="red" left />
