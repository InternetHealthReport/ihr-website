<template>
  ...
  >
    ...
    <template v-slot:option="scope">
      <q-item v-if="scope.opt.type == 'asn'" v-bind="scope.itemProps" v-on="scope.itemEvents" @click="setAsn(scope.opt.value)">
        <h1>{{ asn }}</h1>
      ...
      <q-item v-else-if="scope.opt.type == 'country'" v-bind="scope.itemProps" v-on="scope.itemEvents" @click="setAsn(scope.opt.value)">
