        ...
        <div class="" style="max-width: 400px">
          ...
          <div class="IHR_external-links">
            <div class="row nowrap justify-evenly">
              <a href="https://x.com/ihr_alerts" class="" target="_blank" aria-label="Follow us on X">
                <QIcon name="fab fa-square-x-twitter" class="inline-block" />
              </a>
              <a href="https://github.com/InternetHealthReport" class="" target="_blank" aria-label="Visit our GitHub">
                <QIcon name="fab fa-github-square" class="inline-block" />
              </a>
              <a href="mailto:admin@ihr.live" class="" target="_blank" aria-label="Contact us via email">
