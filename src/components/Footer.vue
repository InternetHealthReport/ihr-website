      ...
      <div class="IHR_fsection">
        <div class="IHR_sitemap " style="max-width: 700px;">
          <ul>
            ...
            <li>
              <RouterLink :to="Tr.i18nRoute({ name: 'covid19' })">{{ $t('footer.reportPages.covid19') }}</RouterLink>
            </li>
          </ul>
          <ul>
            <li class="text-weight-bold links-title text-capitalize">
            ...
            <li>
              <RouterLink :to="Tr.i18nRoute({ name: 'documentation' })">{{ $t('footer.about.title') }}</RouterLink>
            </li>
            <li>
              <RouterLink :to="Tr.i18nRoute({ name: 'documentation', hash: '#AS-dependency' })">{{ $t('footer.documentation.analysisModules') }}</RouterLink>
            </li>
            <li>
              <RouterLink :to="Tr.i18nRoute({ name: 'documentation', hash: '#REST-API' })">{{ $t('footer.documentation.dataAccess') }}</RouterLink>
            </li>
          </ul>
          <ul>
            <li class="text-weight-bold links-title text-capitalize">
            ...
            <li>
              <RouterLink :to="Tr.i18nRoute({ name: 'documentation', hash: '#Acknowledgements' })">{{ $t('footer.about.acknowledgments') }}</RouterLink>
            </li>
            <li>
              <RouterLink :to="Tr.i18nRoute({ name: 'documentation', hash: '#Data-policy' })">{{ $t('footer.about.datapolicy') }}</RouterLink>
            </li>
          </ul>
        </div>
      </div>
