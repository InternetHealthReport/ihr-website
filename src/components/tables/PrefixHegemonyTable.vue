  ...
  <div>
      ...
      >
              ...
              <QTr>
                  ...
                  <QTh colspan="2"
                      ><h3>
                          ...
                          <QIcon name="far fa-question-circle" color="grey" style="font-size: 0.9em" right />
                          <QTooltip max-width="360px">
                              <div v-html="$t(`documentationPage.sections.prefixasdependency.description.2.body`)"></div>
                          </QTooltip></h3
                  ></QTh>
              </QTr>
              <QTr>
          ...
          <template v-slot:body-cell-country="props">
              <QTd :props="props">
                  <RouterLink class="IHR_delikify" :to="Tr.i18nRoute({ name: 'country', params: { cc: props.row.country } })">
                      {{ props.row.country }}
                  </RouterLink>
              </QTd>
          </template>
          ...
          <template v-slot:body-cell-originASN="props">
              <QTd :props="props">
                  <RouterLink
                      class="IHR_delikify"
                      :to="Tr.i18nRoute({ name: 'network', params: { id: ihr_api.ihr_NumberToAsOrIxp(props.row.originasn.asn) } })"
                  >
          ...
          <template v-slot:body-cell-dependencies="props">
              <QTd :props="props">
                  <span v-for="dep in sorted(props.row.dependencies)" :key="dep.prefix" class="comma">
                      <RouterLink
                          class="IHR_delikify"
                          :to="Tr.i18nRoute({ name: 'network', params: { id: ihr_api.ihr_NumberToAsOrIxp(dep.asn) } })"
                      >
                          <span
