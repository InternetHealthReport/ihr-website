  ...
  Bangladesh: {
    ...
    eyeball: [
      ...
      },
      {
        as: 45245,
        'as-descr':
          'banglalink an Orascom Telecom Company, providing GSM Telecom service in Bangladesh',
  ...
  'Northern Cyprus': {
    ...
    eyeball: [
      ...
      },
      {
        as: 8544,
        'as-descr':
          'Transit AS for PrimeTel (AS16229), SpiderNet (AS5425) and NetWay (AS30916) traffic',
        autnum: 'NSP-INTL',
        cc: 'CY',
