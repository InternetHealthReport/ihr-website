...
describe('zipAggregatedAttrs', () => {
  it('should correctly zip aggregated attributes', () => {
    const aggregatedAttrsDict = {
      counts: ['hegemony_alarm_counts', 'network_delay_alarm_counts', 'ihr_outages_alarm_counts'],
      timebins: [
    ...
    expect(zippedData).toEqual([
      ...
      ['ihr_outages_alarm_counts', 'ihr_outages_alarm_timebins', 'ihr_outages_alarm_severities']
    ])
  })
