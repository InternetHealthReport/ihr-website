    ...
    const expectedResult = [
      {
        asn: 1848,
        asn_name: 'AS1848',
        asn_country: 'United States of America',
        asn_country_iso_code2: 'US',
        asn_country_iso_code3: 'USA',
        bgp_entity: [1848],
        bgp_entity_type: ['asn'],
        bgp_entity_name: ['AS1848'],
        bgp_entity_country: ['United States of America'],
      ...
      },
      {
        ...
        asn_country: 'Iran, Islamic Republic of',
        ...
        network_disconnection_stream_country: ['Iran, Islamic Republic of'],
      ...
      },
      {
        ...
        asn_name:
          'MCRBN-AS Federal State Unitary Enterprise of the Order of the Red Banner of Labour "Russian Broad-casting and Notification Network"',
        asn_country: 'Russian Federation',
      ...
      },
      {
        ...
        network_delay_startpoint_country: ['United States of America'],
        ...
        network_delay_endpoint_country: ['United States of America'],
  ...
  it('should correctly ETL AggregatedAlarmsDataModel for third party alarms only', async () => {
    ...
    const expectedResult = [
      ...
      },
      {
        ...
        submoas_asn_attacker_country: ['United States of America'],
        ...
        submoas_asn_victim_country: ['United States of America'],
      ...
      },
      {
        ...
        asn_country: 'Venezuela, Bolivarian Republic of',
        ...
        submoas_asn_attacker_country: ['Venezuela, Bolivarian Republic of'],
    ...
    const expectedResult = [
      {
        ...
        moas_asn_attacker_country: ['United States of America'],
      ...
      },
      {
        ...
        moas_asn_victim_country: ['United States of America'],
